...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!--- Заметки --->	
	<td colspan='3'><label> <?php echo Yii::t('general','New assortment items codes'), ' (' , Yii::t('general','comma separated'), ')'; ?></label>
	<div>
		<?php		 			
			if ($UserRole<=5 OR ($UserRole==6 && $CurrentStatusOrder < 4))
			{
				echo $form->textArea($model,'Notes',array('rows'=>7, 'cols'=>70)); 
