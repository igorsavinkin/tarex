...
<?php 
		if (!Yii::app()->user->checkAccess(User::ROLE_ADMIN)) 
			$condition = 'organization = ' . Yii::app()->user->organization . ' AND isEmployee = 1 ';
		else
			$condition = '1=1';
	...
	<td>
	<span style="white-space:nowrap;"><label><?php echo Yii::t('general','User in system, whom to lay off'); ?></label></span>
	<br>
