...
$this->pageTitle =Yii::t('general','Recruitment'); 
...
?>
<h1><?php echo Yii::t('general','Recruitment'); ?></h1><br> 
<?php 
 ...
 $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'author' => array( 
			...
			'header'=>Yii::t('general','User in system, who hires'), 
		),		
		'contractorId' => array( 
			'name'=>'contractorId',
			'header'=>Yii::t('general','User in system, whom to hire'),
