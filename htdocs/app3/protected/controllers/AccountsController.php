	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array( 'admin_old','delete'),
				'users'=>array('admin'),
			),
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Accounts']))
		{
			...
			if($model->save()){
				...
				$User=User::model()->findByPk($model->ParentCustomer);
				//echo $User->username;
				
				
				$criteria=new CDbCriteria;
				$criteria->condition='ParentCustomer = '.$model->ParentCustomer;
				$criteria->select='AccountCurrency, Sum(AccountLimit) as AccountLimit';
				$criteria->group='AccountCurrency';
				...
				foreach ($Accounts as $r){
					...
					$User->Accounts.=$Currency->name.'='.$r->AccountLimit.';';
					//echo 'CustomerName '.$r->ParentCustomer; 
				//	$User->Childs.=$r->CustomerName.';';
				}
				$criteria=new CDbCriteria;
				$criteria->condition='ParentCustomer = '.$model->ParentCustomer;
				$Accounts=Accounts::model()->findall($criteria);
				...
				//echo 'Childs '.$User->Childs; 
				//$User->notes=$User->Accounts;
				if ($User->save())
