...
$this->pageTitle =Yii::t('general','Calls'); 
...
?>
<h1><?php echo Yii::t('general','Calls'); ?></h1><br> 
<?php 
 ...
 $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'author' => array( 
			...
			'header'=>Yii::t('general','User in system, who calls'),  
		),		 
		'contractorId' => array( 
			'header'=>Yii::t('general','User in system, whom to call'),
			'name'=>'contractorId',
