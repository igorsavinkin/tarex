...
<?php 
	...
	<td>
		 <div style='float:left;'><span style='white-space:nowrap;'>
			<?php echo $form->label($model,'totalSum'); ?></span><br>
			<?php echo $form->textField($model,'totalSum', array('size'=>15,'maxlength'=>200)); ?>
		</div>	
		<div style='float:left;padding-left:20px;'>	 
			<?php echo $form->label($model, 'eventNumber'); ?><br>
			<?php echo $form->textField($model, 'id' , array('size'=>15 ,'maxlength'=>200)); ?>
		</div>	
	...
	<td valign='top' width='250'>
		<?php  
			...
			{   echo $form->label($model,'organizationId'); 
				...
				echo '<br>', CHtml::Link(Yii::t('general','Edit Organizations') , array('organization/admin'), array('target'=>'_blank')); 
			}  
		   ?>
	</td>  
	<td align=center>
