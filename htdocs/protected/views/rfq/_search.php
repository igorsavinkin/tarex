...
<?php 
	...
	<p style='font: 10px gray; font-weight: bold;clear:both; padding: 0 10;'><?php echo Yii::t('general', 'You may optionally enter a comparison operator' ), ' (<, <=, >, >=, <>, =) ', Yii::t('general','at the beginning of each of your search values to specify how the comparison should be done') ; ?></p>
	</td>
</tr><tr>
	<td>
