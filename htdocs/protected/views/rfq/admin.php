...
$this->pageTitle =Yii::t('general','RFQ');
...
"); 
?>
<h1><?php echo Yii::t('general','RFQ'); ?></h1><br> 
<?php 
if(Yii::app()->user->role<6){
	echo CHtml::link(Yii::t('general','Advanced Search'),'#',array('class'=>'search-button btn-win')); 
}
echo CHtml::link(Yii::t('general','Create') . ' ' . Yii::t('general', 'RFQ' ) , array('create', 'new'=>1), array( 'class' => 'btn-win')); ?>
