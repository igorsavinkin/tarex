...
<?php 
$origin =  $_POST['origin'] ? CHtml::encode($_POST['origin']) : Organization::model()->findByPk(Yii::app()->user->organization)->address;

$destination = $_POST['destination'] ? CHtml::encode($_POST['destination']) : Organization::model()->findByPk(User::model()->findbypk($model->contractorId)->organization /*Yii::app()->user->organization*/)->address; ?>
