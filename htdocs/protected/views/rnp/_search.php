...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <td><?php if (Yii::app()->user->checkAccess(User::ROLE_MANAGER)) :  ?>
	<div style="white-space:nowrap;"><?php echo $form->label($model,'authorId'); ?></div><!--br-->&nbsp;
<?php  
	...
	<td>
	   ...
	   endif; // конец того что только для менеджера и выше ?>
	</td>
	
	<td valign='middle' ><label><?php echo Yii::t('general','New assortment items codes'); ?></label> 
