...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<td>	<?php echo CHtml::ajaxSubmitButton('ajaxSubmitButton', array('Contractor/update', 'id'=> $model->id), array('success'  => 'js: function(data) { $("#locator").html(data); } 
		function() { $.fn.yiiGridView.update("#contractor-grid");}'
		)); ?>
	</td>
</tr></table> 
<?php $this->endWidget(); ?>
