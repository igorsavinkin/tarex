...
$this->pageTitle =Yii::t('general','Delivery in'); // Eventtype::model()->findByAttributes(array('name'=>$_GET['Reference']))->Reference);      
?>
<h1><?php echo Yii::t('general','Delivery in'); ?></h1><br> 
<?php  
