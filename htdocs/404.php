...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/8943fcf6/select2.css" />
<script type="text/javascript" src="/assets/df744518/jquery.js"></script>
<script type="text/javascript" src="/assets/df744518/jui/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="/assets/df744518/jquery.yii.js"></script>
<script type="text/javascript" src="/assets/8943fcf6/select2.js"></script>
<title>345 
      404 - Страница не найдена  | "Тарекс" </title> 
...
<div style="display:none"><input type="hidden" value="130568fc1b5aaddf76bb30a258e979252b164f37" name="YII_CSRF_TOKEN" /></div>		
		    <p class="simply"></p>
			<p class="tar_border"></p>
			<p class="tar_location"></p>
		<select class="ch_city" name="Cityes[Name]" id="Cityes_Name">
<option value="Абакан">Абакан</option>
<option value="Аббан">Аббан</option>
...
<option value="Санкт-Петербург" selected="selected">Санкт-Петербург</option>
...
<option value="Яхрома">Яхрома</option>
			...
			<div class="tar_lang">
				<div class="tar_rus_eng">
				 ...
				 <form action="/" method="post">
<div style="display:none"><input type="hidden" value="130568fc1b5aaddf76bb30a258e979252b164f37" name="YII_CSRF_TOKEN" /></div>						<p class="simply"></p><p class="tar_border_lang"></p>	
						<select name="_lang" id="_lang">
<option value="en_us">English</option>
<option value="ru" selected="selected">Русский</option>
</select>			 
				</form>				</div><!-- tar_rus_eng -->
			</div>
		</div><!-- tar_lang_all -->
	                          </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tar_search">
                                <form action="/?r=assortment/index" method="get">
<div style="display:none"><input type="hidden" value="assortment/index" name="r" /></div><input placeholder="OEM, артикул или название запчасти" type="text" value="" name="findbyoem-value" id="findbyoem-value" />                                    <input type="submit" class="form_submit" value="Поиск" >
                                 </form>                            </div>	

							<div class="tar_basket">
                                <a class="tar_bas" href="/?r=assortment/cart" >
                                    <img src="/images/tar_basket.png">
									<span id='cart-content'>КОРЗИНА<br />0 товар(ов)<br>на 0 рублей									</span> 
                                </a>
                            </div>							
        ...
        <div class="tar_body"><?php echo 'Yii::app()->request->requestUrl = ', Yii::app()->request->requestUrl; ?>
            <div class="tar_slider" style="margin-top: 100px; text-align:center;">
                 <h1>404 - Страница не найдена!</h1>
         
            </div>
               <div class="tar_cont" style="margin-top:100px; text-align:center;">
					<p>Но не расстраивайтесь, Вы можете перейти на <a href="\">главную страницу</a> или воспользоваться поиском<!--a href="#">картой сайта</a-->.</p>
            </div>
        </div>
    </div>
</div>
<footer style="margin: 350px 0 0 0;">
    <div class="container">
        <div class="tar_left_cont_foot">
            <a class="tar_bot_logo" href="/?r=site/index">
...
style="width:80px; height:15px; border:0;" alt="??????.???????" title="??????.???????: ?????? ?? ??????? (?????????)" onclick="try{Ya.Metrika.informer({i:this,id:18697171,lang:'ru'});return false}catch(e){}"/></a>
<!-- /Yandex.Metrika informer -->
        ...
        <div class="tar_right_cont_foot">
            <div class="tar_top_cont_foot">
                <div class="tar_foot_menu">
                    <ul class="foot_menu">
                        <li>
                            <a href="/?r=site/index&page=company">
                                О компании  
                            </a>
                        </li>
                        <li>
                            <a href="/?r=site/index&page=contacts">
                                Контакты  
                            </a>
                        </li>
                        <li>
                            <a href="/?r=site/index&page=products">
                                Продукция 
                            </a>
                        </li>
                        <li>
                            <a href="/?r=site/index&page=spareparts">
                                Автозапчасти 
                            </a>
                        </li>
                    </ul>
...
/*<![CDATA[*/
jQuery(function($) {
jQuery('#Cityes_Name').select2({'formatNoMatches':function(){return "Не найдено результатов";},'formatInputTooShort':function(input,min){return "Пожалуйста, введите "+(min-input.length)+" символа для поиска";},'formatInputTooLong':function(input,max){return "Please enter "+(input.length-max)+" less characters";},'formatSelectionTooBig':function(limit){return "You can only select "+limit+" items";},'formatLoadMore':function(pageNumber){return "Загрузка результатов...";},'formatSearching':function(){return "Поиск...";},'allowClear':false,'width':'200'});
jQuery('body').on('change','#_lang',function(){jQuery.yii.submitForm(this,'',{});return false;});
});
/*]]>*/
</script>
